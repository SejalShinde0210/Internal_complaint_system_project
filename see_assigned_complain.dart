...
class _SeeAssignedComplainPageState extends State<SeeAssignedComplainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Assigned Complaint'),
          ...
          children: [
            TableRow(
              ...
              children: [
                ...
                _buildTableCell('extension', bold: true), // New column header for Extension
            ...
            for (int index = 0; index < complaints.length; index++)
              TableRow(
                children: [
                  ...
                  _buildTableCell(complaints[index]['extension']), // New cell for Extension
