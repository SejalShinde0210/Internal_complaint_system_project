...
class AssignComplainPagefacility extends StatefulWidget {
  @override
  _AssignComplainPagefacilityState createState() => _AssignComplainPagefacilityState();
}

class _AssignComplainPagefacilityState extends State<AssignComplainPagefacility> {
  ...
  Future<List<Map<String, dynamic>>> fetchData() async {
    final response = await http.get(
      Uri.parse("http://192.168.255.224:8080/php_connection/assign_complaint_facility.php"),
  ...
  Future<void> sendDataToServer(
    ...
    var url = Uri.parse('http://192.168.255.224:8080/php_connection/assigned_complaint_facility.php');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Assign complain Facility'),
